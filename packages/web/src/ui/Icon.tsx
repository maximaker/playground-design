...
const PATHS = {
  ...
  swap: 'M2.6 5.2h9M9.2 2.8l2.4 2.4-2.4 2.4M13.4 10.8h-9M6.8 8.4 4.4 10.8l2.4 2.4',
  ...
  list: 'M2.6 4h10.8M2.6 8h10.8M2.6 12h10.8',
  ...
  chevronLeft: 'm9.8 3.6-4.4 4.4 4.4 4.4',
  ...
  unlink: 'M6.6 9.4a2.8 2.8 0 0 0 2.6.75M12.6 7.4a2.8 2.8 0 0 0-4-4l-1 1M9.4 6.6a2.8 2.8 0 0 0-3.4-.5M3.4 8.6a2.8 2.8 0 0 0 4 4l1-1M2 2l12 12',
  // A horseshoe magnet: two legs, a curved back, tips left open.
  magnet: 'M4 13.2V7a4 4 0 0 1 8 0v6.2M4 13.2h2.6V7a1.4 1.4 0 0 1 2.8 0v6.2H12',
  ruler: 'M1.8 10 10 1.8l4.2 4.2L6 14.2zM4.6 7.2l1.4 1.4M6.8 5l1.4 1.4M9 2.8l1.4 1.4',
